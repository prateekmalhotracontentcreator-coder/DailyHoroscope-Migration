...
> Last updated: 2026-06-05 v6.0 (Faith Pass 3 NOT accepted → Pass 4 brief written. Root cause confirmed: multi-word situation constants verbatim in scanned fields. 7 surgical changes across 4 page types. Transit v4 + Tarot v4 + CRY-L3-CONT all ready to issue.)
