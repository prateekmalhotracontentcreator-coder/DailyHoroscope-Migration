...
> **INGEST FREEZE in effect (14 May 2026).** No new chapters to be ingested until KE Phase 1.2 Sprint 2 (arbitration runtime) is delivered and gated. This includes Ch 54-60, A Text Book Ch 15, and Yoga chapters. Validation re-runs on existing batches are still allowed.
