...
| **ARC-2** | Dynamic Confidence Engine (3-pillar wiring + decay + notifications) | 🟣 READY TO ISSUE | `CODEX_COMMISSION_ARC_2_CONFIDENCE_QUESTIONNAIRE.md` -- brief rewritten 2026-05-17. KE-Sprint3 blocker cleared. Issue after KE-Sprint3 live verification. |
