...
| v1.6 | 2026-05-15 | KE-OP-9 confirmed already present (knowledge_engine.py lines 634-636). KE-OP-10 fixed: added `combust_ok` guard to `_planet_in_kendra_conditions_ok` in `ke_yoga_evaluator.py`; cleaned up `_unsupported_note`. Both closed. | CC | -- |
