...
> Last updated: 2026-06-02 · v5.8 (M3-CP-FIX v5-FULL issued. v3-v4 were uncommitted thread state; actual repo still at 93.4% original. Brief now targets original file directly: 2 hardcoded FAQ strings eliminated, summary f-string broken into 3 variants, chart-point vocabulary separation, sign-adjective title alternation. No new functions constraint explicit.)
