...
> Last updated: 2026-06-02 · v5.9 (M3-CP-FIX v6 issued. v5-FULL confirmed FAQ fix working (92.4% scan). Summary templates still failing at 35% due to fixed closing clauses. v6: delete _SUMMARY_TEMPLATES, single dense f-string with no fixed spans; _CP_TITLE_LABEL for 2-word chart-point labels fixes L3 Jaccard.)
