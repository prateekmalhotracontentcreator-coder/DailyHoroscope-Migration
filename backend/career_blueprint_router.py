...
from career_blueprint_prompt_service import enrich_career_blueprint_with_claude
...
async def generate_career_blueprint(payload: BirthInput, request: Request) -> GenerateResponse:
    ...
    report = await enrich_career_blueprint_with_claude(report, {"natal_snapshot": natal})
