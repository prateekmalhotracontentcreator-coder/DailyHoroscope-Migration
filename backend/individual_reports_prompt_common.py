...
DEFAULT_CLAUDE_MODEL = os.getenv("INDIVIDUAL_REPORTS_CLAUDE_MODEL", "claude-3-5-sonnet-20241022")
...
async def try_claude_generation(prompt: str, *, max_tokens: int = 700, temperature: float = 0.45) -> dict[str, Any] | None:
    try:
