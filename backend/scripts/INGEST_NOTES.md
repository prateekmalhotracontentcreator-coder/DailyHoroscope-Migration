...
**Production verification (2026-05-14):** Dry-run confirmed against live MongoDB -- `rules_updated=24, rules_skipped=0, errors=0`. Migration is complete on production. No further action required.
