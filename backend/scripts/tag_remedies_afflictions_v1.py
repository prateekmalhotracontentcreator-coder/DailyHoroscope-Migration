...
LOCAL_JSON_FILES = {
    "interpretation_rules": [
        ...
        SCRIPTS_DIR / "gemstone_rules.json",    # gemstones (100)
        SCRIPTS_DIR / "crystal_rules.json",     # crystals (100)
        SCRIPTS_DIR / "dhana_rules.json",       # dhana/donation (100)
        SCRIPTS_DIR / "chakra_rules.json",      # chakra (7)
    ],
    "knowledge_rules": [
        SCRIPTS_DIR / "lk_remedies.json",       # Lal Kitab (361)
    ],
}
