...
- Be specific and personalised — address the native by name throughout
- EVERY array must have at least 3-5 items — never return empty arrays
- NO markdown in JSON string values

Return this EXACT JSON structure with EXACT field names as shown:
{
    ...
    "yogas": [{"name": "...", "type": "benefic", "planets_involved": ["..."], "effect": "..."}],
    "career_prediction": {
        "overall_rating": "...",
        "business_potential": "...",
        "best_career_fields": ["...", "...", "...", "...", "..."],
        "strengths_at_work": ["...", "...", "...", "...", "..."],
        "career_timeline": [{"period": "2026-2028", "prediction": "...", "advice": "..."}]
    },
    "love_prediction": {
        "overall_rating": "...",
        ...
        "compatibility_signs": ["...", "...", "..."],
        "challenging_signs": ["...", "...", "..."],
        "marriage_timing": {"favorable_years": [2027, 2028, 2029], "favorable_months": ["..."]},
        "married_life": ["...", "...", "..."]
    },
    "health_prediction": {
        "overall_vitality": "...",
    ...
    "dasha_timeline": [
        {"planet": "Saturn", "period": "2028 – 2047", "effects": ["...", "...", "..."]},
        {"planet": "Mercury", "period": "2047 – 2064", "effects": ["...", "...", "..."]}
    ],
    "mangal_dosha": {"has_dosha": false, "severity": "...", "effects": "...", "remedies": ["...", "...", "..."]},
    "kalsarp_dosha": {"has_dosha": false, "severity": "", "remedies": []},
    "benefic_yogas": [{"name": "...", "type": "benefic", "planets_involved": ["..."], "effect": "..."}],
    "gemstone_remedies": ["...", "...", "..."],
    "mantra_remedies": ["...", "...", "..."],
    "lifestyle_remedies": ["...", "...", "...", "...", "..."],
    "lucky_numbers": [1, 5, 6],
    ...
    "lucky_days": ["...", "...", "..."],
    "lucky_direction": "...",
    "numerology": {"life_path": "...", "destiny_number": "...", "soul_number": "..."}
}"""

    user_prompt = f"""Generate a complete premium Brihat Kundli Pro report for {request.full_name} using this calculated chart:

{chart_summary}

IMPORTANT:
- Use exact house placements and planetary positions above — never change them
- Every array must have at least 3-5 specific items relevant to this chart
- compatibility_signs and challenging_signs must always have 3 signs each
- good_investments and avoid must always have 3-5 items each  
- dasha_timeline must include Saturn and Mercury periods with actual year ranges
- Make every prediction specific to the actual planets and houses shown"""
    ...
    try:
        ...
        return StreamingResponse(
            ...
            headers={
                ...
                "X-PDF-Password-Hint": f"Password: {password}",
            }
        )
    except Exception as e:
