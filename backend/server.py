...
async def generate_brihat_kundli(request: BrihatKundliRequest, user_email: str = ""):
    ...
    try:
        ...
        if isinstance(current_dasha_raw, str):
            current_dasha = {"mahadasha": current_dasha_raw, "effects": []}
        elif isinstance(current_dasha_raw, dict):
            # Map current_dasha key → mahadasha key
        ...
        # Mangal Dosha — merge calculator data with Claude interpretation
        mangal = report_data.get("mangal_dosha", {})
