  ...
  useEffect(() => {
    try {
      ...
      if (stored) {
        ...
        // Show again if: version mismatch, older than 7 days, or missing prefs
        if (parsed.version !== COOKIE_VERSION || daysSince > 7 || !parsed.prefs) {
          // Clear stale consent so fresh banner shows
