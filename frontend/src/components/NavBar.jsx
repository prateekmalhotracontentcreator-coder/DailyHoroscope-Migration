...
const BOTTOM_NAV = [
  ...
  { label: 'Reports',   icon: FileText, path: '/birth-chart' },
        ...
        <div className="flex items-center justify-between h-14 px-4">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="font-playfair font-semibold text-lg hidden sm:block">Everyday Horoscope</span>
              <span className="font-playfair font-semibold text-lg sm:hidden">EH</span>
            </button>
          </div>
        ...
        <div className="flex items-stretch h-16">
          {BOTTOM_NAV.map((item) => {
            const isActive = location.pathname === item.path ||
              ...
              (item.path === '/birth-chart' && ['/birth-chart', '/kundali-milan', '/brihat-kundli', '/ask-question', '/love-report', '/career-plus', '/palmistry'].includes(location.pathname));
            return (
              <button
                key={item.label}
                onClick={() => navigate(item.path)}
              ...
              >
                ...
                {isActive && <div className="absolute bottom-0 h-0.5 w-8 bg-gold rounded-full" style={{ position: 'relative' }} />}
              </button>
            );
          })}
        </div>
