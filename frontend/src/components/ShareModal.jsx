...
export const ShareModal = ({ isOpen, onClose, reportType, reportId }) => {
  ...
  const shareViaEmail = () => {
    const subject = `My ${reportType === 'birth_chart' ? 'Birth Chart' : 'Kundali Milan'} Analysis`;
    const body = `Check out my ${reportType === 'birth_chart' ? 'Birth Chart' : 'Kundali Milan'} analysis from Cosmic Wisdom!\n\n${shareLink}`;
