...
export const BirthChartPage = () => {
  ...
  return (
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
      <SEO
        title="Birth Chart Analysis — Vedic Astrology Report"
        description="Generate your personalised Vedic birth chart analysis. Discover your ascendant, planetary positions, and life path insights based on your exact birth details."
            ...
            <>
              <div className="flex items-center justify-between">
                <p className="text-sm text-muted-foreground">
                  Using saved birth details for <span className="font-medium text-foreground">{birthProfile.name}</span>
                </p>
                <Button
                  variant="outline"
                  size="sm"
                  onClick={handleResetProfile}
                  className="gap-1.5 text-xs border-border hover:border-destructive hover:text-destructive transition-colors"
                >
                  <ArrowLeft className="h-3 w-3" /> Edit / Change Details
                </Button>
              </div>
              <BirthDetailsForm
