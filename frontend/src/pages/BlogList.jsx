...
export const BlogList = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Astrology Blog — Cosmic Insights & Zodiac Guides"
        description="Explore our astrology blog for in-depth zodiac guides, Vedic astrology insights, planetary transit reports, and cosmic wisdom to guide your daily life."
        url="https://everydayhoroscope.in/blog"
      />
      <Header />
