    ...
    <div className="min-h-screen bg-background">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {post.video_url && getYouTubeId(post.video_url) && (
          <div className="aspect-video rounded-xl overflow-hidden mb-8 relative group cursor-pointer"
            onClick={() => window.open(post.video_url, '_blank')}
          >
            <img
              src={`https://img.youtube.com/vi/${getYouTubeId(post.video_url)}/maxresdefault.jpg`}
              alt={post.title}
              className="w-full h-full object-cover"
            />
