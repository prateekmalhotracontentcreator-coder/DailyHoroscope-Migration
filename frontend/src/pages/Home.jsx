  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        description="Access your daily, weekly, and monthly horoscope, birth chart analysis, Kundali Milan, and more — all in one place."
        url="https://everydayhoroscope.in/home"
      />
      {/* Header */}
      <Header />
