...
import { ArrowLeft, Crown, Check, Heart } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center gap-2 bg-gold/10 border border-gold/30 text-gold px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-widest mb-3">
            ...
            Marriage Compatibility · ₹999
          </div>
          <h1 className="text-4xl font-playfair font-semibold mb-2">Kundali Milan</h1>
          <p className="text-muted-foreground text-sm">Ashtakoot Guna Milan — classical Vedic compatibility analysis for marriage</p>
        </div>
        ...
        <div className="border border-gold/20 rounded-lg bg-gold/5 p-5 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-x-8 gap-y-2">
            {[
              'Compatibility score out of 36', 'Mangal Dosha assessment',
              'All 8 Kootas explained', 'Planetary harmony analysis',
              'Both North Indian charts', 'Relationship strengths',
              'Ashtakoot Guna breakdown', 'Marriage timing guidance',
              'Challenges & remedies', 'Compatible & challenging signs',
              'Personalised remedies', 'PDF download included',
            ].map(item => (
