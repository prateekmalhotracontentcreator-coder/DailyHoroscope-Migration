...
const PLANS = [
  {
    ...
    ctaAction: 'register', navigateTo: '/register',
    features: ['Daily horoscope for your sign', 'Weekly forecast', 'Monthly outlook', 'Free Kundali Milan score', 'Cosmic Blog access'],
  },
  {
  ...
  {
    name: 'Premium Monthly', price: '₹1,599', period: 'per month', description: 'Full access to all Vedic reports', highlight: true, cta: 'Start Premium',
    ctaAction: 'pay',
    features: ['Unlimited Birth Chart reports', 'Unlimited Kundali Milan', 'Love & Relationship report', 'PDF downloads', 'Priority report generation', 'Social sharing'],
  },
  {
  ...
  },
  {
    ...
    ctaAction: 'navigate', navigateTo: '/brihat-kundli',
