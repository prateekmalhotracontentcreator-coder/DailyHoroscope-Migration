...
export const Login = () => {
  ...
  const triggerShake = () => {
    ...
    setTimeout(() => setShakeCheckbox(false), 600);
  };
  ...
  const handleGoogleLogin = () => {
    ...
    // Use hardcoded backend URL to avoid www vs non-www mismatch
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <Card className="w-full max-w-md p-8 border-2 border-gold/30">
        ...
        {/* T&C Checkbox */}
        <div
          className={`flex items-start space-x-3 p-3 rounded-lg border mb-4 transition-all duration-200 ${
            shakeCheckbox
        ...
        >
          ...
          />
          <label htmlFor="login-terms" className="text-sm font-normal text-muted-foreground cursor-pointer leading-relaxed">
            I agree to the{' '}
            ...
            {!agreedToTerms && <span className="text-red-500 text-xs block mt-1">← Required to sign in</span>}
          </label>
        </div>
