  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO
        ...
        description="Choose your cosmic plan. Free daily horoscopes forever, or unlock Premium for unlimited Birth Charts, Kundali Milan, and Brihat Kundli Pro reports. Starting at ₹0."
        url="https://everydayhoroscope.in/pricing"
        schema={{
          "@context": "https://schema.org",
          "@type": "FAQPage",
          "mainEntity": [
            { "@type": "Question", "name": "Is the daily horoscope free forever?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, daily, weekly, and monthly horoscopes are completely free with no credit card required." } },
            { "@type": "Question", "name": "Can I cancel Premium anytime?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, you can cancel your Premium subscription at any time from Account Settings. You keep access until the end of your billing period." } },
            { "@type": "Question", "name": "What payment methods are accepted?", "acceptedAnswer": { "@type": "Answer", "text": "All major cards, UPI, net banking, and wallets via Razorpay — India's most trusted payment gateway." } }
          ]
        }}
      />
      <Header />
