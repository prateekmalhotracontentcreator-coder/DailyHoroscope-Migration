  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        description="Get your free weekly horoscope for all 12 zodiac signs. AI-powered Vedic astrology weekly predictions covering love, career, health, and finances."
      ...
      <Header />
          ...
          <h1 className="text-4xl font-playfair font-semibold mb-8 text-center">Weekly Horoscope</h1>
