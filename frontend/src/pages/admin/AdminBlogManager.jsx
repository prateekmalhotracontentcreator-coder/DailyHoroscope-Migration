...
export const AdminBlogManager = ({ getAuthHeaders: getAuthHeadersProp }) => {
  const { getAuthHeaders: getAuthHeadersCtx } = useAdminAuth();
  const getAuthHeaders = getAuthHeadersProp || getAuthHeadersCtx;
