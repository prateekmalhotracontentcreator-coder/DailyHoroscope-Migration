...
export const AdminBlogManager = ({ getAuthHeaders }) => {
  ...
  const [formData, setFormData] = useState({
    title: '',
    slug: '',  // always auto-generated, never shown in form
    excerpt: '',
    content: '',
  ...
  const handleInputChange = (e) => {
    ...
    setFormData(prev => {
      ...
      // Auto-generate slug from title when title changes (only for new posts)
      ...
      {showEditor && (
        <Card className="p-6 bg-gray-800 border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <Label className="text-gray-300">URL Slug (auto-generated from title)</Label>
              <Input
                name="slug"
                value={formData.slug}
                readOnly
              ...
              />
              <p className="text-xs text-gray-500 mt-1">💡 SEO tip: Use keyword-rich titles for better Google ranking</p>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              />
              <p className="text-xs text-gray-500 mt-1">Paste a direct image URL (e.g. from Unsplash, Imgur, etc.)</p>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              />
              <p className="text-xs text-gray-500 mt-1">Paste a YouTube link — it will show as a clickable thumbnail in the blog post</p>
            </div>
