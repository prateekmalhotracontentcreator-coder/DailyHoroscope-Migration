...
const LOVE_REPORTS = [
  ...
  { type: "lunar_cycle_wellness", slug: "lunar-cycle", label: "Lunar Cycle Wellness", description: "Your personal wellness rhythm across the 30-day moon cycle", accent: "#7b5ea7", tint: "rgba(123, 94, 167, 0.12)", icon: "☽" },
